...
const Docente = require("../../clases/models/modelo-docente");

// * Listar todos los docentes
router.get("/", async (req, res, next) => {
  let docentes;
  try {
    docentes = await Docente.find({}, "-password");
  } catch (err) {
...
// 	try {
// 		esValidoElPassword = bcrypt.compare(password, docenteExiste.password);
// 	} catch (error) {
// 		const err = new Error(
...
// 	}
// 	res.json({
// 		mensaje: 'Docente logueado', // ? (3) El docente existe
// 	});
// });
